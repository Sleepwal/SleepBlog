<template>
  <div>
    <el-button type="primary" @click="showEdit('add')" class="m-2" icon="plus">新增</el-button>
...
<script setup>
import {addOrUpdateCategory, deleteCategory, getAllCategoryList} from "@/api/category";
import {
  Delete,
  Edit,
...
const submitForm = () => {
  formDataRef.value.validate(async valid => {
    ...
    let resp = await addOrUpdateCategory(params)
